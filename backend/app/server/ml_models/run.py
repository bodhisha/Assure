...
parser.add_argument('-f','--file', default='app/server/ml_models/test')
parser.add_argument('-m','--model_path', type=str, default='app/server/ml_models/blur_jpg_prob0.5.pth')
