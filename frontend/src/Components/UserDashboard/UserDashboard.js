      ...
      {loading ? (
        ...
        <div>
          <div className="text-blue-900 font-semibold text-lg p-1 pr-2 mb-2">
            {" "}
            Want to get your claim processed quickly? Fill out the details with
            your registered insurance number.
          </div>
            ...
            <div className="px-3">
              ...
              <div className="mb-4">
                ...
                {fakeProbability?.front_view && (
                  <div className="text-red-500 font-semibold text-sm">
                    Percentage of being a deepfake:{" "}
                    {fakeProbability?.front_view}%
                  </div>
                )}
              </div>
              ...
              {fakeImages && (
                <div className="bg-gray-100 p-1 rounded-md font-bold text-red-500 flex gap-x-1 items-center">
                  ...
                  <div>
                    The Images uploaded has been detected as FAKE. Kindly upload
                    new images.
                  </div>
                </div>
              )}
              {isForgery && (
                <div className="bg-gray-100 p-1 rounded-md font-bold text-red-500 flex gap-x-1 items-center">
                  ...
                  <div>
                    The Images uploaded has been detected as forged. Kindly
                    upload new images.
                  </div>
                </div>
              )}
