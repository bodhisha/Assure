  ...
  return (
    <div className="shadow-xl h-full lg:h-screen">
      <div className="absolute inset-0">
        ...
        />
        <div
          className="absolute inset-0 bg-gradient-to-r from-gray-700 to-yellow-200"
      ...
      <div className="flex flex-col sm:flex-row relative items-center h-full  px-4 py-16 sm:px-6 sm:py-24 lg:py-16 lg:px-8">
        <div className="w-full">
          <h1 className="text-center text-4xl font-extrabold tracking-tight sm:text-5xl lg:text-6xl">
            <div className="font-bold text-7xl text-red-100 mx-auto">
              ASSURE
            </div>
            <span className="block text-3xl font-bold text-red-100">
              Automated Insurance Claim Platform
            </span>
          </h1>
          <p className="mt-6 max-w-lg mx-auto text-center text-xl italic text-red-100 sm:max-w-3xl">
